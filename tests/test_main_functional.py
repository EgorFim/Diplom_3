...
class TestMainFunctional:
    ...
    def test_move_to_konstruktor_folder_after_click(self,user,driver_get):
    ...
    def test_click_lenta_zakazov_button(self,user,driver_get):
        main_page = MainPage(driver_get)
    ...
    def test_appearance_details_window_after_click(self,user,driver_get):
        main_page = MainPage(driver_get)
    ...
    def test_close_ingredient_window(self,user,driver_get):
        main_page = MainPage(driver_get)
        main_page.click_button_bun()
    ...
    def test_change_ing_counter(self,user,driver_get):
        main_page = MainPage(driver_get)
    ...
    def test_make_order(self,user,driver_get):
        main_page = MainPage(driver_get)
        login_page = LoginPage(driver_get)
