...
class TestPersonalAccount:
    ...
    def test_move_in_pers_acc_after_click_button_licn_kab(self,user_2,driver):
    ...
    def test_move_istoriya_zakazov_folder(self,user_2,driver):
        main_page = MainPage(driver)
        login_page = LoginPage(driver)
        login_page.enter_account()
    ...
    def test_exit_account(self,user_2,driver):
        main_page = MainPage(driver)
        login_page = LoginPage(driver)
        login_page.enter_account()
        main_page.click_button_lichnyi_kabinet_in_header()
