...
class TestPassword:
    ...
    def test_move_to_restore_password_window_after_click(self,user,driver_get):
    ...
    def test_add_email_and_click_button_vosstanovit(self,user,driver_get):
        main_page = MainPage(driver_get)
        login_page = LoginPage(driver_get)
        main_page.click_button_lichnyi_kabinet_in_header()
        login_page.click_buttonТ_vosstanovit()
    ...
    def test_make_password_visible(self,user,driver_get):
        main_page = MainPage(driver_get)
        login_page = LoginPage(driver_get)
        main_page.click_button_lichnyi_kabinet_in_header()
